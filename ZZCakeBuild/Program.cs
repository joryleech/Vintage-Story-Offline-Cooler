...
namespace CakeBuild
{
    ...
    {
        public const string ProjectName = "OfflineCooler";
    ...
    public sealed class PackageTask : FrostingTask<BuildContext>
    {
        public override void Run(BuildContext context)
        {
            ...
            foreach (var documentationFile in new[] { "README.md", "CHANGELOG.md", "LICENSE" })
            {
                if (context.FileExists($"../{documentationFile}"))
                {
                    context.CopyFile($"../{documentationFile}", $"../Releases/{context.Name}/{documentationFile}");
                }
            }
